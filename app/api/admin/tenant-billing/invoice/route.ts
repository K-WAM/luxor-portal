...
export async function POST(request: NextRequest) {
  try {
    ...
    const storagePath = `${bill.property_id}/tenant-invoices/${fileName}`;
    ...
    console.error("Error uploading tenant invoice PDF:", error);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error("Error removing tenant invoice PDF:", error);
