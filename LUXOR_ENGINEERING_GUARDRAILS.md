...
- Paid rent must be assigned by `paid_date`, not `due_date`, and shared-lease duplicates must be de-duplicated before monthly totals are shown. Future months must not be auto-populated as paid rent.
